        ...
        <div className="mt-8 md:mt-10 hero-video-wrap aspect-[16/9] max-w-6xl mx-auto animate-fade-in-up">
          ...
          <div className="content h-full w-full flex flex-col justify-between px-6 pt-6 pb-3 md:px-10 md:pt-8 md:pb-4 text-white">
            ...
            <div className="flex items-start gap-2 md:gap-3">
              {/* CVI — sol, bileşik */}
              <div className="relative flex-none w-[155px] md:w-[175px] pt-4">
              ...
              {/* Ayırıcı */}
              <div className="w-px self-stretch bg-white/25 rounded-full flex-none mt-4" />
              {/* 4 alt indeks — sağ, tek satır */}
              <div className="grid grid-cols-4 gap-1.5 flex-1 mt-4">
